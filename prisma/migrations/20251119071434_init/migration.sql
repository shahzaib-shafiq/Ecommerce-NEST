...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'COD', 'BANK_TRANSFER', 'WALLET');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID', 'FAILED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "InventoryEvent" AS ENUM ('PURCHASE', 'CANCEL', 'REFUND', 'ADMIN_UPDATE');

-- CreateEnum
CREATE TYPE "ShippingStatus" AS ENUM ('PENDING', 'SHIPPED', 'IN_TRANSIT', 'OUT_FOR_DELIVERY', 'DELIVERED', 'FAILED', 'RETURNED');
